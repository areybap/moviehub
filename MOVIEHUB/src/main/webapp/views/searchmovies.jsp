...
<head>
    ...
    <link rel="stylesheet" href="../styles/searchmovies.css?v=112">
...
<header class="navbar">
    ...
    <main>
        ...
        <div class="tags">
            <div id="languagetags">
                <div class="languagetag" id="en">english</div>
                <div class="languagetag" id="te">telugu</div>
                <div class="languagetag" id="hi">hindi</div>
            </div>
            <div id="genretags">
                <div class="genretag" id="en">trolololol</div>
                <div class="genretag" id="en">action</div>
                <div class="genretag" id="en">adventure</div>
            </div>
        </div>
    ...
    <script src="../scripts/searchmovies.js"></script>
</body>
